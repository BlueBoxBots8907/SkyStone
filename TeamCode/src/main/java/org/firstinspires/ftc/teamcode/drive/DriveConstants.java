...
public class DriveConstants {
    ...
    public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(34, 1, 14);
    ...
    public static double TRACK_WIDTH = 15.1;
    ...
    public static double getMotorVelocityF() {
        ...
        return 12.3;//32767 / getTicksPerSec();
    }

    public static double getRawMaxRpm() {
    return MOTOR_CONFIG.getMaxRPM();
    }
}
